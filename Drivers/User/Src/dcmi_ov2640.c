/***
   ...
   *  @description
	*
	*	实验平台：反客STM32H7B0VBT6核心板 （型号：FK7B0M2-VBT6）+ OV2640模块（型号：OV2640M1-200W） 
...
/****************************************************************************  
   数据引脚                       时钟和同步引脚
	...
	PE1     ------> DCMI_D3
	PD3     ------> DCMI_D5        SCCB 控制引脚，初始化在 camera_sccb.c 文件
	PE4     ------> DCMI_D4        PB8  ------> SCCB_SCL
