...
#define  OSPI_P1_CLK_PIN							GPIO_PIN_2								   // OSPI_P1_CLK 引脚
#define	OSPI_P1_CLK_PORT							GPIOB										   // OSPI_P1_CLK 引脚端口
#define	OSPI_P1_CLK_AF								GPIO_AF9_OCTOSPIM_P1						// OSPI_P1_CLK IO口复用
#define 	GPIO_OSPI_P1_CLK_ENABLE      			__HAL_RCC_GPIOB_CLK_ENABLE()	 	   // OSPI_P1_CLK 引脚时钟

#define  OSPI_P1_NCS_PIN					      GPIO_PIN_6								   // OSPI_P1_NCS 引脚
#define	OSPI_P1_NCS_PORT						   GPIOB										   // OSPI_P1_NCS 引脚端口
#define	OSPI_P1_NCS_AF						      GPIO_AF10_OCTOSPIM_P1				   // OSPI_P1_NCS IO口复用
#define 	GPIO_OSPI_P1_NCS_ENABLE        	   __HAL_RCC_GPIOB_CLK_ENABLE()	 	   // OSPI_P1_NCS 引脚时钟

#define  OSPI_P1_IO0_PIN						   GPIO_PIN_11								   // OSPI_P1_IO0 引脚
#define	OSPI_P1_IO0_PORT						   GPIOD										   // OSPI_P1_IO0 引脚端口
#define	OSPI_P1_IO0_AF						      GPIO_AF9_OCTOSPIM_P1						// OSPI_P1_IO0 IO口复用
#define 	GPIO_OSPI_P1_IO0_ENABLE        	   __HAL_RCC_GPIOD_CLK_ENABLE()	 	   // OSPI_P1_IO0 引脚时钟

#define  OSPI_P1_IO1_PIN						   GPIO_PIN_12								   // OSPI_P1_IO1 引脚
#define	OSPI_P1_IO1_PORT						   GPIOD										   // OSPI_P1_IO1 引脚端口
#define	OSPI_P1_IO1_AF						      GPIO_AF9_OCTOSPIM_P1						// OSPI_P1_IO1 IO口复用
#define 	GPIO_OSPI_P1_IO1_ENABLE        	   __HAL_RCC_GPIOD_CLK_ENABLE()	 	   // OSPI_P1_IO1 引脚时钟

#define  OSPI_P1_IO2_PIN						   GPIO_PIN_2								   // OSPI_P1_IO2 引脚
#define	OSPI_P1_IO2_PORT						   GPIOE										   // OSPI_P1_IO2 引脚端口
#define	OSPI_P1_IO2_AF						      GPIO_AF9_OCTOSPIM_P1						// OSPI_P1_IO2 IO口复用
#define 	GPIO_OSPI_P1_IO2_ENABLE        	   __HAL_RCC_GPIOE_CLK_ENABLE()	 	   // OSPI_P1_IO2 引脚时钟

#define  OSPI_P1_IO3_PIN						   GPIO_PIN_13								   // OSPI_P1_IO3 引脚
#define	OSPI_P1_IO3_PORT						   GPIOD										   // OSPI_P1_IO3 引脚端口
#define	OSPI_P1_IO3_AF						      GPIO_AF9_OCTOSPIM_P1					   // OSPI_P1_IO3 IO口复用
#define 	GPIO_OSPI_P1_IO3_ENABLE          	__HAL_RCC_GPIOD_CLK_ENABLE()	 	   // OSPI_P1_IO3 引脚时钟
